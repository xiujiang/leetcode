 ...
 * 你有一辆油箱容量无限的的汽⻋，从第 i 个加油站开往第 i+1 个加油站需要消耗汽油 cost[i] 升。你从其中的一个加 油站出发，开始时油箱为空。
 * 如果你可以绕环路行驶一周，则返回出发时加油站的编号，否则返回 -1。 说明:
 * 如果题目有解，该答案即为唯一答案。 输入数组均为非空数组，且⻓度相同。 输入数组中的元素均为非负数。
 * 示例 1:
 * 输入:
 ...
 */
public class OneHandredThirtyFour {
    public static void main(String[] args) {
        int[] x = new int[]{1,2,3,4,5};
        int[] y = new int[]{3,4,5,1,2};
        System.out.println(canCompleteCircuit1(x,y));
    }
